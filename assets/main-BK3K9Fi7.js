      ...
      <div class="exercise-card-header">
        ...
        <button class="start-btn" data-id="${y}">
          ...
          <svg class="icon-arrow">
            <use href="${d}#icon-arrow-start"></use>
          </svg>
        </button>
      </div>
